  ...
  return (
    <div className="mx-auto max-w-7xl px-4 pt-[200px] ">
      <ParallaxImg
        ...
        className="md:w-3/12 w-9/12 rounded-3xl  md:rounded-xl mx-auto md:mr-[100%]"
      />
      <ParallaxImg
        src="/AIN.png"
        alt="AIN"
        ...
        className="mx-auto md:w-5/12 w-3/4  rounded-3xl "
      />
      <ParallaxImg
        src="/CAZ.png"
        alt="Date"
        ...
        className="ml-auto md:w-1/3 w-2/4 rounded-xl"
      />
      <ParallaxImg
        src="/HT.png"
        alt="TXB"
